...
public class OutlineSelection : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            highlight = raycastHit.collider.gameObject;
            if (highlight.CompareTag("Selectable") && highlight != selection)
            {
                ...
                else
                {
                    ...
                    highlight.GetComponent<Outline>().OutlineColor = Color.magenta;
                    highlight.GetComponent<Outline>().OutlineWidth = 7.0f;
                }
            }
            else
            {
...
// from https://www.youtube.com/watch?v=qYnAkMGbgwo
